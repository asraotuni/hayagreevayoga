...
document.addEventListener("click", (event) => { if (!event.target.closest(".account-menu")) document.querySelectorAll(".account-menu.open").forEach((menu) => menu.classList.remove("open")); });
...
// Reuse the existing Amplify configuration and session for authenticated portal actions.
export { loadAuth, loadConfig };
